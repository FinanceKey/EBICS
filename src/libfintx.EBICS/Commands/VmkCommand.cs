...
{
    internal class VmkCommand : GenericCommand<VmkResponse>
    {
        private static readonly ILogger s_logger = EbicsLogging.CreateLogger<VmkCommand>();
        ...
        internal VmkParams Params { private get; set; }
